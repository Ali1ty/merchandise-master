    ...
    <div class="flex content-center items-center flex-wrap h-screen">
        <div class="w-full sm:w-1/2 lg:w-1/3 p-2 mx-auto">
            <div class="w-full max-w-sm mx-auto">
                <form action="{!! route('postAuthenticate') !!}" method="POST" class="bg-white shadow-2xl rounded-lg px-8 pt-6 pb-8 mb-4 border-t-4 border-blue-800">
                    {{csrf_field()}}
                    <img src="{{asset('images/main-logo.png')}}" class="w-3/4 mx-auto pb-6" alt="">
                    ...
                    <div class="flex items-center justify-between">
                        <button
                            class="bg-purple-800 mr-auto w-full rounded-full irsans text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-purple-700 hover:text-white"
                            type="submit">
                            تائید
                        </button>
                    </div>
